...
import { createTopping } from '~/services/toppingService.js';

const ToppingModalCreate = ({ isVisible, onCancel }) => {
    ...
    const createHandler = async () => {
        try {
            ...
            const response = await createTopping(token, {
                topping_name,
                description
            });
...
export default ToppingModalCreate;
